...
def get_data_loaders(
    ...
    "train": transforms.Compose([
       ...
       # Applying random affine transformations (rotation, translation, shear)
       ...
       # Applying a horizontal flip with 50% probability (only half of them will undergo the flipping)
       transforms.RandomHorizontalFlip(0.5),
       # Taking a 224x224 random part of the image
       transforms.RandomCrop(224, padding_mode="reflect", pad_if_needed=True),
       # Augmentations num_ops, magnitude
    ...
    "valid": transforms.Compose([
        # Resizing  256x256
        transforms.Resize(256),
        # Taking the central 224x224 part of the image
